...
# Load new dataset
data = load_breast_cancer()#New dataset
...
def objective_function(state):
    ...
    model = RandomForestClassifier(
        ...
        min_samples_leaf=state['min_samples_leaf'],#New hyperparameter to get better results. Controls the minumu mnumber of samples required on the leaves of the trees helping to prevent overfitting.
        random_state=42
    )
...
def get_neighbors(state):
    ...
    steps = {
        ...
        'max_depth': 2,
        'min_samples_split': 1,
        'min_samples_leaf': 1  # Step for this hyperparameter
    }
...
initial_state = {
    ...
    'max_depth': 10,
    'min_samples_split': 2,
    'min_samples_leaf': 1, #New hyperparámeter
}
...
best_state, best_value = steepest_ascent_hill_climbing(initial_state)
print("Initial Hyperparameters:", initial_state)
print("Best Hyperparameters Found:", best_state)
print("Best Cross-Validation Accuracy:", best_value)
